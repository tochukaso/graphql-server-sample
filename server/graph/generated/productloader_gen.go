...
func (l *ProductLoader) unsafeSet(key int, value *model.Product) {
	if l.cache == nil {
		l.cache = map[int]*model.Product{}
	}
	l.cache[key] = value
}
...
func (b *productLoaderBatch) keyIndex(l *ProductLoader, key int) int {
